...
<div class="container">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="telefono" class="form-control" id="telefono" placeholder="Ej. 3183423251">
        </div>
        <div class="mb-3">
            <label for="direccion" class="form-label">Dirección</label>
            <input type="text" name="direccion" class="form-control" id="direccion" placeholder="Ej. Calle, Carrera, Diagonal...">
        </div>
