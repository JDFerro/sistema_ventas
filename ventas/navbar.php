<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-2 shadow rounded">
  <div class="container-fluid">
    <a class="navbar-brand me-5" href="#" style="display: flex; align-items: center;">
      <img src="logosales.png" alt="smart shopping Logo" style="height: 40px; width: auto; max-width: 600px; object-fit: contain;">
    </a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="reporte_ventas.php">
            <i class="fa fa-file-alt"></i> Reporte ventas
          </a>
        </li>
      </ul>
      <ul class="navbar-nav">
