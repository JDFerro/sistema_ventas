...
<div class="container mt-3"> 
    ...
    <div>
            ...
            <tbody>
                <?php foreach($_SESSION['lista'] as $lista) {?>
                    <tr>
                        ...
                        <td>$<?php echo number_format($lista->venta, 0, ',', '.');?></td>
                        <td><?php echo $lista->cantidad;?></td>
                        <td>$<?php echo number_format(floatval($lista->cantidad * $lista->venta), 0, ',', '.');?></td>
                        <td>
        ...
        <div class="text-center mt-3">
            <h1>Total: $<?php echo number_format($total, 0, ',', '.');?></h1>
